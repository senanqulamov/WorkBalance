...
namespace App\Livewire\Seller\Logs;
...
class Index extends Component
{
    ...
    {
        return view('livewire.seller.logs.index');
    }
    ...
    {
        // For now, only show logs where this seller is the user who triggered the event.
        return Log::query()->where('user_id', $userId);
    }
