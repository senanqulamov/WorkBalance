    ...
    $roleConfig = [
        ...
        'admin' => [
            ...
            'items' => [
                ...
                ['route' => 'humanops.overview', 'pattern' => 'humanops.*', 'label' => __('HumanOps'), 'icon' => 'heart'],
        ...
        'humanops' => [
            ...
            'accent' => 'slate',
            'hoverBg' => 'hover:bg-slate-600/20',
            'activeBg' => 'bg-slate-600',
            'items' => [
                ['route' => 'humanops.overview', 'pattern' => 'humanops.overview|humanops.dashboard', 'label' => __('Overview'), 'icon' => 'home'],
                ['route' => 'humanops.departments', 'pattern' => 'humanops.departments', 'label' => __('Departments'), 'icon' => 'building-office'],
                ['route' => 'humanops.risk-signals', 'pattern' => 'humanops.risk-signals', 'label' => __('Risk Signals'), 'icon' => 'exclamation-triangle'],
                ['route' => 'humanops.trends', 'pattern' => 'humanops.trends', 'label' => __('Trends'), 'icon' => 'chart-bar'],
                ['route' => 'humanops.recommendations', 'pattern' => 'humanops.recommendations', 'label' => __('Recommendations'), 'icon' => 'light-bulb'],
                ['route' => 'humanops.privacy', 'pattern' => 'humanops.privacy', 'label' => __('Privacy & Trust'), 'icon' => 'shield-check'],
            ],
        ],
        'workbalance' => [
            ...
            'activeBg' => 'bg-gradient-to-r from-blue-500/20 to-purple-500/20',
            'items' => [
                ['route' => 'workbalance.dashboard', 'pattern' => 'workbalance.dashboard|workbalance.home', 'label' => __('Dashboard'), 'icon' => 'home'],
                ['route' => 'workbalance.daily-checkin', 'pattern' => 'workbalance.daily-checkin', 'label' => __('Daily Check-In'), 'icon' => 'heart'],
                ['route' => 'workbalance.trends', 'pattern' => 'workbalance.trends', 'label' => __('My Trends'), 'icon' => 'chart-bar'],
                ['route' => 'workbalance.tools', 'pattern' => 'workbalance.tools', 'label' => __('Well-being Tools'), 'icon' => 'sparkles'],
                ['route' => 'workbalance.insights', 'pattern' => 'workbalance.insights', 'label' => __('Insights'), 'icon' => 'light-bulb'],
            ],
        ],
    ];
